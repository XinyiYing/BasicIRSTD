...
## Datasets
* **NUST-SIRST** &nbsp; [[download dir]](https://github.com/wanghuanphd/MDvsFA_cGAN) &nbsp; [[paper]](https://openaccess.thecvf.com/content_ICCV_2019/papers/Wang_Miss_Detection_vs._False_Alarm_Adversarial_Learning_for_Small_Object_ICCV_2019_paper.pdf)
...
* **NUDT-SIRST-Sea** &nbsp; [[download dir]](https://github.com/TianhaoWu16/Multi-level-TransUNet-for-Space-based-Infrared-Tiny-ship-Detection) &nbsp; [[paper]](https://ieeexplore.ieee.org/document/10011449/)
* **IRDST** &nbsp; [[download dir]](https://github.com/sun11999/RDIAN) &nbsp; [[paper]](https://ieeexplore.ieee.org/document/10011452/)

**We used the NUAA-SIRST, NUDT-SIRST, IRSTD-1K for both training and test. 
Please first download our datasets via [Baidu Drive](https://pan.baidu.com/s/1kpnH26Vk-1gqO22K6fVpqQ?pwd=1113) (key:1113), and place the 3 datasets to the folder `./datasets/`. More results will be released soon!** 
...
## Recources
* **We provide the result files generated by the aforementioned methods, and researchers can download the results via [Baidu Drive](https://pan.baidu.com/s/1P8C2SoKBaL1mYqvjnPCw4g?pwd=1113) (key:1113).**
* **The pre-trained models of the aforementioned methods can be downlaoded via [Baidu Drive](https://pan.baidu.com/s/192YaDl8Uks_FOSCBj6u_bw?pwd=1113) (key:1113).**
<br><br>
